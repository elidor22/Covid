...
public class DisplayImage {
    ...
    public DisplayImage() throws IOException
    {
        ...
        BufferedImage img=ImageIO.read(new File("concern.jpg"));
        BufferedImage img2=ImageIO.read(new File("cases.jpg"));
        BufferedImage img3=ImageIO.read(new File("New_cases.jpg"));
